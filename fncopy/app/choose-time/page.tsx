...
function ChooseTimeContent() {
    ...
    return (
        <MainLayout currentStep={1} progressPercentage={33}>
            {/* Notification Popup */}
            {notification && (
                <div
                    style={{
            ...
            <div className="w-full h-full max-w-7xl mx-auto flex flex-col p-6">
                {/* Header Section */}
                <div className="flex flex-col md:flex-row justify-between items-center mb-8 flex-shrink-0 gap-4">
                    <div>
                ...
                <div className="border border-gray-200 rounded-3xl p-8 bg-white shadow-sm mb-10">
                    <div className="flex-col gap-10 flex-1 min-h-0">
                        {/* Main Column: Date and Time Selection */}
                        <div className="w-full space-y-0">
                            ...
                            <div className="pb-8">
                                <div className="flex flex-col md:flex-row gap-10">
                                    <div className="w-full md:w-1/3 flex items-start gap-3">
                                        ...
                                        <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider pt-1.5">Select Date</h3>
                                    </div>
                            ...
                            {selectedDateIndex !== null && (
                                <div className="py-8 border-t border-gray-200 animate-in fade-in slide-in-from-top-4">
                                    <div className="flex flex-col md:flex-row gap-10">
                                        <div className="w-full md:w-1/3 flex items-start gap-3">
                                            <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 flex-shrink-0">
                                                <SunIcon />
                                            </div>
                                            <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider pt-1.5">Time of Day</h3>
                                        </div>
                                        <div className="w-full md:w-2/3">
                                            <label className="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <div className="py-8 border-t border-gray-200 animate-in fade-in slide-in-from-top-4">
                                    <div className="flex flex-col md:flex-row gap-10">
                                        <div className="w-full md:w-1/3 flex items-start gap-3">
                                            ...
                                            <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider pt-1.5">Specific Time</h3>
                                        </div>
                                        <div className="w-full md:w-2/3">
                                            <label className="block text-sm font-medium text-gray-700 mb-2">
